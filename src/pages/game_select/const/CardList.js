...
export const CardList = [
  ...
  { name: "Border Quiz", link: "/border-quiz", img: PixelatedFlagQuizImage, subtitle: "Find the missing border!", instructions: "You will see two countries and their borders, but one shared border is missing, it's your job to find it!", backgroundColor: "hsl(70, 20%, 20%)" }
];
